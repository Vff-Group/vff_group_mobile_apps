...
class MyClothingWishListPage extends StatefulWidget {
  const MyClothingWishListPage({super.key});

  @override
  State<MyClothingWishListPage> createState() => _MyClothingWishListPageState();
}

class _MyClothingWishListPageState extends State<MyClothingWishListPage> {
  List exercisesArr = [
    {
      "name": "Set 1",
      "set": [
                  ...
                  child: Column(
                    ...
                    children: [
                      RoundDarkButton(
                          ...
                          onPressed: () {
                            Navigator.pushNamed(
                                context, ClothingDeliveryAddressRoute);
                          })
                    ],
                  ),
                )
    ...
    child: Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            onPressed: (){},
            icon: Icon(Icons.shopping_cart_checkout,color: Colors.blue,),
          ),
        ],
      ),
    ),
