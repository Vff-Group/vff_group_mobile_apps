...
class MyClothingCartPage extends StatefulWidget {
  const MyClothingCartPage({super.key});

  @override
  State<MyClothingCartPage> createState() => _MyClothingCartPageState();
}

class _MyClothingCartPageState extends State<MyClothingCartPage> {
  List exercisesArr = [
    {
      "name": "Set 1",
      "set": [
