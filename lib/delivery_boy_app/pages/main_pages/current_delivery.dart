...
class _CurrentDeliveryPageState extends State<CurrentDeliveryPage> {
  ...
  bool isOrderDelivered = false,isOrderPickup = false,isOrderProcessing=false;
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          InkWell(
            onTap: () {
              _showPopup(context, isOrderPickup, isOrderProcessing, isOrderDelivered);
            },
            child: Padding(
                                ...
                                child: Radio(
                                  ...
                                  onChanged: (value) {
                                    ...
                                    setState(() {
                                      ...
                                      if(isOrderProcessing == false || isOrderPickup == false){
                                        isOrderDelivered = false;
                                      }
                                    });
                                  },
