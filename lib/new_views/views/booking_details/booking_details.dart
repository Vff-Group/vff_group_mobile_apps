...
class NewBookingsDetails extends StatefulWidget {
  const NewBookingsDetails({super.key});

  @override
  State<NewBookingsDetails> createState() => _NewBookingsDetailsState();
}

class _NewBookingsDetailsState extends State<NewBookingsDetails> {
