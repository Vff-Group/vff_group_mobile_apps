    ...
    return Scaffold(
      backgroundColor: AppColors.whiteColor,
       appBar: AppBar(
          ...
          title: FadeAnimation(
            delay: 0.3,
            child: Text('Dry Clean Price Chart',
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text('Price can vary depending upon the Item Type. These are regular prices.',style: nunitoStyle.copyWith(
                ...
                child: TabBarView(
                  children:
                    ...
                    categoryScreen = SectionsPageDryClean(
                      catId: "16",
                      catName: "Dry Clean",
                      catImage: "http://vffgroup.in/media/img_e10ce137-2de4-47c0-b4d8-f383ede22747.jpg",
