...
class OrderDetailsPage extends StatefulWidget {
  ...
  @override
  State<OrderDetailsPage> createState() => _BookingDetailsPageState();
}

class _BookingDetailsPageState extends State<OrderDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            bookingStatus.isEmpty ? 'Order Details' : 'Booking Details',
